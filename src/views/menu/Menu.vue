        ...
        <div class="overflow-x-auto">
          <table class="w-full">
            ...
            <tbody class="divide-y divide-gray-200/50">
              <tr v-for="menu in store.makanan" :key="menu.id"
                ...
                <td class="px-6 py-4">
                  <span class="inline-flex px-3 py-1 rounded-full text-sm font-bold shadow-sm"
                ...
                <td class="px-6 py-4">
                  <div class="flex gap-2">
                    <button @click="handleEdit(menu)"
                      class="px-4 py-2 bg-gradient-to-r from-yellow-400 to-orange-400 hover:from-yellow-500 hover:to-orange-500 text-white rounded-lg font-medium transition-all duration-200 transform hover:scale-105 shadow-sm">
                      Edit
                    </button>
                    <button @click="handleDelete(menu.id)"
                      class="px-4 py-2 bg-gradient-to-r from-red-500 to-pink-500 hover:from-red-600 hover:to-pink-600 text-white rounded-lg font-medium transition-all duration-200 transform hover:scale-105 shadow-sm">
                      Hapus
                    </button>
                    <button @click="toggleTersedia(menu)"
                      class="px-4 py-2 bg-gradient-to-r from-blue-500 to-purple-500 hover:from-blue-600 hover:to-purple-600 text-white rounded-lg font-medium transition-all duration-200 transform hover:scale-105 shadow-sm">
                      Status
                    </button>
                  </div>
                </td>
      ...
      <div class="bg-white/80 backdrop-blur-sm rounded-xl shadow-lg border border-white/20 overflow-hidden">
        <div class="overflow-x-auto">
          <table class="w-full">
            ...
            <tbody class="divide-y divide-gray-200/50">
              <tr v-for="menu in store.minuman" :key="menu.id"
