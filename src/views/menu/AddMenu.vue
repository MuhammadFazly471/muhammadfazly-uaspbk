...
<template>
  <div class="w-full min-h-screen bg-gradient-to-br from-gray-50 via-orange-50 to-amber-50 p-6">
    ...
    <div class="max-w-7xl mx-auto mb-10">
      ...
      <p class="text-gray-600 mt-1">Tambahkan menu baru untuk restoran</p>
      ...
      <div class="bg-white/80 backdrop-blur-sm shadow-2xl rounded-2xl border border-white/30">
        ...
        <div class="bg-gradient-to-r from-orange-500 to-red-500 px-8 py-6 rounded-t-2xl">
          <div class="flex items-center gap-3">
            ...
            <h2 class="text-xl font-bold text-white">🍽️ Form Menu Baru</h2>
          </div>
        </div>

        <!-- Form Content -->
        <div class="p-8 sm:p-10">
          <form @submit.prevent="handleSubmit" class="grid grid-cols-1 sm:grid-cols-2 gap-8">
            <!-- Nama Menu -->
            <div class="space-y-2 col-span-2">
              ...
              <input
                ...
                class="w-full border-2 border-gray-200 rounded-xl px-4 py-3 text-gray-800 font-medium focus:outline-none focus:border-orange-400 focus:ring-2 focus:ring-orange-100 transition-all duration-200 bg-gray-50/50"
                required
              />
            </div>
